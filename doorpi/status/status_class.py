...
def collect_status(doorpi_object, modules=None, value=None, name=None):
    if modules is None:
        modules = MODULES
    if value is None:
        value = []
...
class DoorPiStatus(object):
    ...
    def __init__(self, DoorPiObject, modules=None, value=None, name=None):
        if modules is None:
            modules = MODULES
        if value is None:
            value = []
    ...
    def collect_status(self, DoorPiObject, modules=None, value=None, name=None):
        if modules is None:
            modules = MODULES
        if value is None:
            value = []
